...
## Update gtmcoin.conf on server

If you generated a new masternode private key, you will need to update the remote `gtmcoin.conf` files.

Shut down the daemon and then edit the file.

```nano .dashcore/gtmcoin.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `gtmcoin.conf` file.
