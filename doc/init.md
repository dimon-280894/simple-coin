...
Configuration file:  `/etc/dashcore/gentarium.conf`  
...
Configuration file:  `~/Library/Application Support/DashCore/gentarium.conf`  
...
Rename gentariumd.openrc to dashd and drop it in /etc/init.d.  Double
...
Drop gentariumd.conf in /etc/init.  Test by running `service dashd start`
...
Copy gentariumd.init to /etc/init.d/dashd. Test by running `service dashd start`.
