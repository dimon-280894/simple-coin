...
Only requiring some minor changes is gtmcoin.cpp.
...
Changes to gtmcoin.cpp
----------------------
gtmcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
