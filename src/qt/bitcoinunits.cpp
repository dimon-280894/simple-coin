...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(GENTARIUM);
    unitlist.append(mGENTARIUM);
    unitlist.append(uGENTARIUM);
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case GENTARIUM:  return 100000000;
    case mGENTARIUM: return 100000;
    case uGENTARIUM: return 100;
    case duffs: return 1;
...
int BitcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case GENTARIUM: return 8;
    case mGENTARIUM: return 5;
    case uGENTARIUM: return 2;
    case duffs: return 0;
    default: return 0;
    }
}
