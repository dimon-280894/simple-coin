    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Gentarium Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Gentarium Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  gentarium-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Gentarium in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GENTARIUM, 0.1 GENTARIUM, 1 GENTARIUM and 10 GENTARIUM -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Gentarium Core is shutting down...") + "<br /><br />" +
