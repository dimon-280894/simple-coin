 ...
 *
 *   // network
 *   CGentariumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.genterium.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGentariumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CGentariumNetwork(UniValue objIn)
    {
...
// // can be under: GentariumNetwork
// //   -- signature requirements : Key1(User)
// class CGentariumNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == GentariumNetwork);
//     // }
