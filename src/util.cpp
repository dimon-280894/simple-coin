...
const char * const BITCOIN_CONF_FILENAME = "gentarium.conf";
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty gentarium.conf if it does not excist
    ...
    {
        // Don't overwrite existing settings so command line settings override gentarium.conf
