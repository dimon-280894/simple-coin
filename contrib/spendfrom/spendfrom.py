...
def read_bitcoin_config(dbdir):
    """Read the gtmcoin.conf file from dbdir, returns dictionary of settings"""
    ...
    config_parser.readfp(FakeSecHead(open(os.path.join(dbdir, "gtmcoin.conf"))))
...
def main():
    ...
    parser.add_option("--datadir", dest="datadir", default=determine_db_dir(),
                      help="location of gtmcoin.conf file with RPC username/password (default: %default)")
