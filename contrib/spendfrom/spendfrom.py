...
def read_bitcoin_config(dbdir):
    """Read the gentarium.conf file from dbdir, returns dictionary of settings"""
    ...
    config_parser.readfp(FakeSecHead(open(os.path.join(dbdir, "gentarium.conf"))))
...
def main():
    ...
    parser.add_option("--datadir", dest="datadir", default=determine_db_dir(),
                      help="location of gentarium.conf file with RPC username/password (default: %default)")
